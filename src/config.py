...
ECONDATA_DATASET_ID: str = ""  # TODO: fill after discovery

SARB_SERIES: dict[str, str] = {
    # our_name : exact series key inside ECONDATA_DATASET_ID
    "usdzar": "",     # TODO — EXCX135, USD/ZAR exchange rate
    "gold": "",       # TODO — gold price (USD/oz)
    "platinum": "",   # TODO — platinum price, if present in the dataflow
    "sa_3m": "",      # TODO — 3m JIBAR or 3m T-bill rate
    "sa_10y": "",     # TODO — 10y government bond yield
}
...
FEATURE_COLS: list[str] = [
    ...
    "d4_log_platinum",  # 4-week log change in platinum (SA's top PGM export)
